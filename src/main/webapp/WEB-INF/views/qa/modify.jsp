...
<div class="container-sm">
	...
	<form id="modify-form" method="post" action="${root }/board/modify">
			...
			<div class="form-group">
	 		...
	 		<input name="bno" class="form-control" id="input3" readonly value="${board.qa_bno }">
	 		</div>

			<div class="form-group">
		    <label for="input1">제목</label>
		    <input value='<c:out value="${board.qa_title }" />' name="title" type="text" class="form-control" id="input1" placeholder="제목을 입력 하세요.">
		  	</div>		  	
		  	
		  	<div class="form-group">
		    <label for="textarea1">내용</label>
		    <textarea name="content" class="form-control" id="textarea1" rows="3"><c:out value="${board.qa_content }" /></textarea>
		    
		  	</div>
		  	
		  	<div class="form-group">
		    <label for="input2">작성자</label>
		    <input readonly value='<c:out value="${board.qa_writer }" />' name="writer" type="text" class="form-control" id="input2" placeholder="이름을 입력하세요">
		  	</div>
